    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
                ('hosted_on', models.ForeignKey(blank=True, null=True, on_delete='on_delete', related_name='hosted_on_server', to='assets.Server', verbose_name='宿主机')),
            ],
            options={
                'verbose_name': '服务器',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='assets.User', verbose_name='事件执行人')),
            ],
            options={
                'verbose_name': '事件纪录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_unit', models.ForeignKey(blank=True, null=True, on_delete='on_delete', related_name='parent_level', to='assets.BusinessUnit')),
            ],
            options={
                'verbose_name': '业务线',
        ...
        migrations.AddField(
            model_name='asset',
            name='admin',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admin', to='assets.User', verbose_name='资产管理员'),
        ),
        migrations.AddField(
            model_name='asset',
            name='approved_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approved_by', to='assets.User', verbose_name='批准人'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
